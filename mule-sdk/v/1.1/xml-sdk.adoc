...
+
. Run `mvn clean install` in the `/hello-smart-connector` to create the plugin for the `Hello XML SDK` module (This will install parent project as well as child projects).
+
...
(3) When you want to add this connector from your local maven repository to your project in order to test it, you need to only add following dependency, then you can use this connector from your Studio palette. 
----
<dependency>
