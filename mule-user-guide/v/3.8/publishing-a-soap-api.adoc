...
When sending requests to an external web service, using the link:/mule-user-guide/v/3.8/web-service-consumer[Web Service Consumer]﻿ instead of the CXF Module is recommended.
