...
* For an index of all available operators, categorized by the types you need to supply as parameters, see link:/mule-user-guide/v/3.8/dataweave-types#operators-sorted-by-type[DataWeave Operators Sorted by Type].
