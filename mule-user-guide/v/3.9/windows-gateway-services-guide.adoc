...
* link:/mule-user-guide/v/3.9/microsoft-dynamics-ax-2012-connector[Dynamics AX Connector]
* link:/mule-user-guide/v/3.9/microsoft-dynamics-crm-connector[Dynamics CRM Connector]
...
For more information on the MSMQ connector, see the link:/mule-user-guide/v/3.9/msmq-connector-user-guide[MSMQ Connector User Guide].
...
For more information on the PowerShell connector, see the link:/mule-user-guide/v/3.9/windows-powershell-connector-guide[Windows PowerShell Connector Guide].
...
For more information on the CRM connector, see the link:/mule-user-guide/v/3.9/microsoft-dynamics-crm-connector[Microsoft Dynamics CRM Connector Guide.]
...
For more information on the AX connector, see the link:/mule-user-guide/v/3.9/microsoft-dynamics-ax-2012-connector[Microsoft Dynamics AX Connector Guide.]
