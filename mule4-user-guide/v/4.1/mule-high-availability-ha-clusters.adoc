...
You can also choose to define a minimum number of machines required in a cluster for it to remain in an operational state. This grants you a consistency improvement. See  link:creating-and-managing-a-cluster-manually#quorum-management[Quorum Management].
