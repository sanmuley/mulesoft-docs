...
In Anypoint Studio, you can download and open the example project _Cache Scope with Salesforce Contacts_ to learn more about how to use the Cache scope.
