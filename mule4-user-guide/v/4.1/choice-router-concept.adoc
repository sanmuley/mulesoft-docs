...
You can use Anypoint Studio to download the example project _Content-Based Routing_ from Anypoint Exchange for a working example of a flow that uses the Choice router.
