...
The Migration tool (migrator) automates the migration of certain Mule 3
components, connectors, and module configurations to Mule 4. Though it does not
migrate every part of a flow or project, it does output a Mule 4 project with a
report about what remains to be migrated, and it is preconfigured for use with
the <<compatibility_module, Compatibility module>>.
