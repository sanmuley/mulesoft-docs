...
These tables show you the ports or IPs/hostnames to add to your whitelists to allow communication between the Runtime Manager Agent and the Runtime Manager console, depending on the platform region your organization account is setup.
...
Static IPs to be whitelisted to access the mule-manager.eu1.anypoint.mulesoft.com hostname.
