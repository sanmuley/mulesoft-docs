...
To use Anypoint Private Cloud, version 2.0 you must install and configure an NFS server. Before installing or upgrading, you must have an NFS endpoint available. You NFS server must meet the following requirements:
