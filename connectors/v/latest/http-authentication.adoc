...
+
You can use a similar DataWeave expression for the refresh token; however, Github doesn't actually use a refresh token.
+
...
[tab,title="Studio Visual Editor"]
....
On the *Authentication* section, configure the options as follows for the *OAuth2 - Authorization Code*:
