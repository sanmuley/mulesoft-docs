...
. Select the number of replicas you want allocate to the application.
+
See [link to work/core/memory topic] for more information.

. Specify the number of *Cores* and *Memory* you want to allocate to each application replica by adjusting the sliders to the appropriate values.
+
