...
A user-interface for viewing partitions and contents is located at Anypoint Platform> Runtime Manager> Object Store. See link:/object-store/osv2-guide#to-view-data-in-an-object-store .
